...
%	}\par
	...
	\vspace{.8cm}\par									% vertical space
	\rule{4.5cm}{0.4pt}								% horizontal line, first argument width, second thickness
	\vspace{1.6cm}\par								% vertical space
	\rmfamily\mdseries%\bfseries
	\large
	...
	\vspace{.8cm}\par
	\rule{2.5cm}{0.4pt}
	\vspace{1cm}\par								% insert horizontal line, first argument width, second thickness
