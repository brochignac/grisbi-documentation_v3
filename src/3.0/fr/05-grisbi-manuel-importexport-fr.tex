...
\begin{enumerate}
	...
	\end{figure}
		\begin{itemize}
			...
			\item créer une règle d'importation rapide si le fichier est au format \gls{QIF}, \gls{CSV} ou \gls{OFX} et uniquement si vous ajoutez ou marquez des opérations à un compte. Cette règle est spécifique à chaque compte et peut être nommée. Vous pourrez la retrouver dans la barre d'outils du compte (voir \vref{transactions-functions}),%TODO A CORRIGER
