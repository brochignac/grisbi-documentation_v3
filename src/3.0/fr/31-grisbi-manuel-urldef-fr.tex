...
% $Id: grisbi-manuel-urldef.tex, v 3.0 2024/04 Dominique Brochard : add/remove/update mails
% $Id: grisbi-manuel-urldef.tex, v 3.0 2024/11 Dominique Brochard :
% - rename file to 31-xxx
% - replace \urldef{\urlListSF} by \urldef{\urlListDiffGrisbi}
% - update Martin Stromberger mail
% $Id: grisbi-manuel-urldef.tex, v 3.0 2026/08 Dominique Brochard :
% - added : \urldef{\urlSourceForgeGrisbiStable}%
%			\url{https://sourceforge.net/projects/grisbi/files/grisbi\%20stable/}
% - added : \urldef{\urlSourceForgeGrisbiInstable}%
%			\url{https://sourceforge.net/projects/grisbi/files/grisbi\%20unstable/}
% - added : \urldef{\urlGitHubGrisbiWiki}
%			\url{https://github.com/grisbi/grisbi/wiki}
% - added : \urldef{\urlFlatpakGrisbi}%
%			\url{https://flathub.org/fr/apps/org.grisbi.Grisbi}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


\urldef{\urlGrisbi}%
\url{https://www.grisbi.org}
%\href{https://www.grisbi.org}{siteGrisbi}
...
\urldef{\urlSourceForgeGrisbiStable}%
\url{https://sourceforge.net/projects/grisbi/files/grisbi\%20stable/}

\urldef{\urlSourceForgeGrisbiInstable}%
\url{https://sourceforge.net/projects/grisbi/files/grisbi\%20unstable/}

\urldef{\urlSourceForgeDocumentation}%
\url{https://sourceforge.net/projects/grisbi/files/Documentation/}

\urldef{\urlSourceForgeDocumentationFormat}%
\url{https://sourceforge.net/projects/grisbi/files/Documentation/Format-fichier-grisbi/}

\urldef{\urlGitHubGrisbi}%
\url{https://github.com/grisbi/grisbi/}

\urldef{\urlGitHubGrisbiWiki}
\url{https://github.com/grisbi/grisbi/wiki}

\urldef{\urlFlatpakGrisbi}%
\url{https://flathub.org/fr/apps/org.grisbi.Grisbi}
