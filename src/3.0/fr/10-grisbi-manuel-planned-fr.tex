...
Un calendrier s'affiche à la place du bas du panneau de navigation. Il indique en caractères gras les dates auxquelles des opérations planifiées de tous les comptes arrivent à échéance, et en \fboxsep=3pt{\colorbox[RGB]{61,174,233}{\textcolor{white}{\textsf{blanc sur fond bleu}}}} la date du jour.
...
\begin{itemize}
	 ...
	 \item déplacer la sélection avec les touches du clavier \keys{\arrowkeyup} et \keys{\arrowkeydown}.
\end{itemize}

L'opération apparaît alors sur \fboxsep=3pt{\colorbox[RGB]{61,174,233}{fond bleu}} et ses détails s'affichent dans le formulaire.
