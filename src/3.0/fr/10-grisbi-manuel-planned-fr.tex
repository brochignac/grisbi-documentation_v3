...
L'opération apparaît alors sur {\setlength{\fboxsep}{2pt}[RGB]{245,155,155}{fond rose foncé} et ses détails s'affichent dans le formulaire.
...
\begin{enumerate}
	\item sélectionnez-la soit:
		\begin{itemize}
			\item par sélection dans la liste des opérations où elle s'affichera sur {\setlength{\fboxsep}{2pt}[RGB]{245,155,155}{fond rose foncé}},
