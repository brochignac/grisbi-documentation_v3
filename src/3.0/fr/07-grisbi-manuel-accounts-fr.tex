...
\begin{enumerate}
	...
	\item \menus{Sélection du type de compte}\refimage{account-new-type-img} (étape 2/4): 
		\begin{figure}[htbp]
		\begin{center}
			\includegraphics[width=0.95\textwidth]{image/screenshot/account_new_type}
		\end{center}
		\caption{Choix du type du nouveau compte}
...
\begin{tblr}{
	%width=0.95\textwidth,
	colspec={Q[c] Q[3.2cm,c] Q[c] Q[5cm,c] Q[3.2cm,c]},
	...
	02/12/2024 	 & Dupond		 & 20,00		  & Cotisations		   & \menus{Chèque}				\\
	04/12/2024	 & Durant		 & 40,00		  & Cotisations		   & \menus{Chèque}				\\
\end{tblr}
%\end{center}
...
\begin{tblr}{
	...
	\menus{Date} & \menus{Tiers}	 & \menus{Crédit} & \menus{Catégories}					 & \menus{Mode de  règlement} \\
	15/12/2024 	 & Remise de chèques & 60,00		  & \emph{Virement:\\} Chèques à encaisser & \menus{Chèque}			  \\
\end{tblr}
...
\begin{tblr}{
		%width=0.95\textwidth,
		colsep=4pt,							%horizontal space on both sides of columns, default=6
		colspec={Q[colsep=3pt,c] Q[colsep=3pt,2.4cm,c] Q[c] Q[3.8cm,c] Q[4.8cm,c]},
		%colspec={Q[1cm,r] Q[1.5cm,c] Q[1cm,l]},
		%rowspec={Q[m] Q[m] Q[m] Q[m] Q[m]},
		%rowsep=4.5pt,
		%leftsep=4pt,							%default=6
	...
	\menus{Date} & \menus{Tiers}  & \menus{Crédit} & \menus{Catégories}			  & \menus{Remarques} \\
	01/06/2025 	 & Crédit Bitoire & 20 000,00	   & \menus{Virement: Banque Yze} & Dette emprunt Crédit Bitoire			  \\
\end{tblr}
...
\begin{tblr}{
		...
		%colsep=4pt,							%horizontal space on both sides of columns, default=6
		abovesep=6pt,							%default=2
		colspec={Q[2cm,c] Q[3.8cm,c] S Q[6.5cm,c]},	% S (instead of Q) for using siunitx package
		%colspec={Q[1cm,r] Q[1.5cm,c] Q[1cm,l]},
		%rowspec={Q[m] Q[m] Q[m] Q[m] Q[m]},
		%rowsep=4.5pt,
		%leftsep=4pt,							%default=6
	...
	\hspace{-10pt}\textbullet{} Opération mère:	  			&				 &					   &							  \\
	\menus{Date}								 			& \menus{Tiers}  & \menus{Débit}	   & \menus{Catégories}		  	  \\
	01/07/2025   											& Crédit Bitoire & 350,00			   & \menus{Opération ventilée}	  \\
												  			&				 &					   &							  \\
	\hspace{5mm}\textopenbullet{} 1\up{re} opération fille: &				 & 300,00			   & \menus{Virement: Banque Yze} \\
	\hspace{5mm}\textopenbullet{} 2\up{e} opération fille:  &				 & 48,80			   & \menus{Frais financiers: Charges d'emprunts} \\
	\hspace{5mm}\textopenbullet{} 3\up{e} opération fille:	&				 & 1,20				   & \menus{Assurances}			  \\
\end{tblr}
...
\begin{tblr}{
		%width=0.95\textwidth,
		%colsep=4pt,							%horizontal space on both sides of columns, default=6
		colspec={Q[colsep=3pt,c] Q[colsep=3pt,2.4cm,c] Q[colsep=3pt,1.7cm,c] Q[4.4cm,c] Q[3.8cm,c]},
		%colspec={Q[1cm,r] Q[1.5cm,c] Q[1cm,l]},
		%rowspec={Q[m] Q[m] Q[m] Q[m] Q[m]},
		%rowsep=4.5pt,
		%leftsep=4pt,							%default=6
	...
	01/06/2024 	 & Auto Matique & 25 000,00	   & \menus{Virement:\\} Compte Immobilisation & Actif achat voiture	\\
\end{tblr}
...
\begin{tblr}{
		%width=0.95\textwidth,
		%colsep=4pt,							%horizontal space on both sides of columns, default=6
		colspec={Q[colsep=3pt,c] Q[colsep=3pt,2.4cm,c] Q[colsep=4pt,1.7cm,c] Q[4.4cm,c] Q[3.8cm,c]},
		%colspec={Q[1cm,r] Q[1.5cm,c] Q[1cm,l]},
		%rowspec={Q[m] Q[m] Q[m] Q[m] Q[m]},
		%rowsep=4.5pt,
		%leftsep=4pt,							%default=6
	...
	\menus{Date} & \menus{Tiers}		& \menus{Débit} & \menus{Catégories}						& \menus{Remarques}			   \\
	01/06/2025 	 & Dépréciation Voiture & 5 000,00	    & \menus{Virement:\\} Compte Immobilisation & Amortissements: Dépréciation \\
\end{tblr}
