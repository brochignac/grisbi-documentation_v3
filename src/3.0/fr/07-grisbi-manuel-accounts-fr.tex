...
% espace pour changement de thème
\vspacepdf{5mm}
Le panneau de navigation affiche le nom du compte sélectionné sur {\setlength{\fboxsep}{2pt}\colorbox[RGB]{235,149,149}{fond rose foncé}}; la barre d'information affiche, à gauche, le nom du compte et, complètement à droite, le solde de ce compte; le panneau des détails affiche par défaut deux onglets:
\begin{itemize}
...
\section{Clôture d'un compte\label{accounts-closure}}
...
Par exemple, quand l'organisme de crédit Crédit Bitoire vous verse le montant de 20 000.00 \texteuro{} pour acheter chez Auto Matique une voiture qui coûte 25 000.00 \texteuro{}, vous créez un compte de passif appelé \emph{Emprunt}, et dans ce compte, vous saisissez l'opération suivante: 
...
\begin{tblr}{
		%width=0.95\textwidth,
		%colsep=4pt,							%horizontal space on both sides of columns, default=6
		colspec={Q[c] Q[4.2cm,c] Q[c] Q[6.5cm,c]},
		%colspec={Q[1cm,r] Q[1.5cm,c] Q[1cm,l]},
		%rowspec={Q[m] Q[m] Q[m] Q[m] Q[m]},
		%rowsep=4.5pt,
		%leftsep=4pt,							%default=6
	...
	\menus{Date} & \menus{Tiers}		& \menus{Débit} & \menus{Catégories}		   \\
	01/06/2025 	 & Dépréciation Voiture & 5 000,00	    & Amortissements: Dépréciation \\
\end{tblr}
