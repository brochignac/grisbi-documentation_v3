...
\begin{tblr}{
		...
		hspan=minimal,
		hline{2-10},
		vline{1,2,3,4,5}={2,3,5,7,9}{solid},
		%width=0.95\textwidth,
		colspec={Q[1.5cm,c] Q[3cm,c] Q[c] Q[7.6cm,c]},
		cell{1}{1}={c=4}{l},
		cell{4}{1}={c=4}{l},
		cell{6}{1}={c=4}{l},
		cell{8}{1}={c=4}{l},
	...
	jj/mm/aa					& \SetCell{l}Crédit Bitoire	& \SetCell{r} 350.00 & \SetCell{l}\emph{Opération ventilée}					  \\
	\textopenbullet{} 1\up{re} opération ventilée:																								  \\
								&					& \SetCell{r} 300.00 & \SetCell{l}\emph{Virement: Banque Yze}				  \\
	\textopenbullet{} 2\up{e} opération ventilée:																			  						  \\
								&					& \SetCell{r} 49.50	 & \SetCell{l}\emph{Frais financiers: Charges d'emprunts} \\
	\textopenbullet{} 3\up{e} opération ventilée:																			  						  \\
								&					& \SetCell{r} 0.50	 & \SetCell{l}\emph{Assurances}							  \\
\end{tblr}
...
\begin{itemize}
	\item \menus{Date}: jj/mm/aa \menus{Tiers}: Auto Matique \menus{Débit}: 25 000 \menus{Catégorie}: \menus{Virement: Compte Immobilisation} \menus{Remarques}: Actif achat voiture
\end{itemize}
...
\begin{itemize}
	\item \menus{Date}: 31/12/2012 \menus{Tiers}: Dépréciation Voiture \menus{Débit}: 5000 \menus{Catégorie}: Amortissements: Dépréciation
\end{itemize}
