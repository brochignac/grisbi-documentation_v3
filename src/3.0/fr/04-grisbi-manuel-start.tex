...
\textcolor{red}{\strong{Attention}} : pour une entité comptable donnée, il est nécessaire et important de bien distinguer LE \og \indexword{fichier de comptes}\index{fichier de comptes} \fg{} et LES \og \indexword{fichiers de compte}\index{fichiers de compte} \fg{} :
