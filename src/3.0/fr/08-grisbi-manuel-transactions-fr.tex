...
\begin{itemize}
	...
	\item dans la barre de menu, sélectionnez \menus{Affichage - Montrer le formulaire de saisie des opérations};
...
Pour saisir une formule, saisissez-la comme si c'était un texte, par exemple \frquote{3,40-2,10} , puis continuez normalement la saisie des autres champs de votre opération; si elle est mal écrite, elle s'affiche sur fond rouge{couleur}. Lorsque vous la validez, le résultat \frquote{1,30} s'affiche dans le champ de saisie, et si la formule est toujours mal écrite, le message \frquote{\#\#\#ERR\#\#\#} s'affiche à la place et sur fond rouge{couleur}.
...
% espace pour changement de thème
\vspacepdf{5mm}
Lors de la saisie de l'\indexword{opération en devise}\index{opération!en devise}\index{devise!opération} dans le formulaire de saisie, choisissez dans la liste déroulante la devise dans laquelle l'opération doit être enregistrée. Plusieurs questions peuvent se poser\refimage{transactions-changeRate-img}:
