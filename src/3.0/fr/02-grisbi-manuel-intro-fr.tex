...
% END_TODO 
	...
	\item \textcolor{red}{\strong{\textsf{Attention}}}: indique soit un point très important pour la compréhension, soit une erreur à ne pas faire sous peine de dommage important pour vos données;\newline
	\textcolor{red}{\strong{\textsf{Attention}}} indique un point \emph{à respecter impérativement}.
\end{itemize} 
