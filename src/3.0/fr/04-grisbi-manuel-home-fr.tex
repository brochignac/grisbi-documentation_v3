...
\begin{itemize}
	...
	\item ajouter un Nouveau compte au fichier Grisbi: \key{Maj}\key{Ctrl}\key{N};
...
\begin{itemize}
	\item Ouvre un calendrier mensuel (sur le champ de date): \key{Ctrl}\key{Entrée};
...
\begin{itemize}
	\item Ouvre votre navigateur à la page du Manuel de l'Utilisateur de Grisbi: \key{F1}
\end{itemize}
