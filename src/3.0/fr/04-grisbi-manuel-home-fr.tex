...
\begin{itemize}
	...
	\item Sélectionner le premier/dernier onglet (Comptes/États): \key{Page Préc} ou \key{Page Suiv}.
\end{itemize}
...
\begin{itemize}
	\item Ouvrir une liste: \key{Page Préc}, \key{Page Suiv} ou \key{Flèche bas};
	\item Se placer en haut de la liste: \key{Page Préc};
	\item Se placer en bas de la liste: \key{Page Suiv};
...
\begin{itemize}
	...
	\item Mois précédent ou suivant: \key{Page Préc} ou \key{Page Suiv};
...
\begin{itemize}
	...
	\item Mois précédent ou suivant: \key{Page Suiv} ou \key{Page Préc};
	\item Année précédente ou suivante: \key{Ctrl} \key{Page Suiv} ou \key{Ctrl} \key{Page Préc}
	\item Valide la date sélectionnée \key{Entrée}
\end{itemize}
...
%\newcommand{\PageUpSymbol}{
%	\textuparrow \hspace{-0.65em} - \hspace{0.2em\vspace{1em}} - \hspace{0.2em} -
%}
%\PageUpSymbol  \uparrow


\newcommand{\PageUpSymbol}%
	{$\uparrow$%
	\kern-0.48em\rule[.25em]{.47em}{.7pt}%
	\kern-0.48em\rule[.05em]{.47em}{.7pt}%
	\kern-0.48em\rule[-.18em]{.47em}{.7pt}%
	}
