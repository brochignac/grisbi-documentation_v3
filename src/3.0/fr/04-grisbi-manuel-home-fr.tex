...
\Note{}: dans le menu \menus{Édition}, certaines entrées ne sont actives que lorsqu'un compte ou une opération est sélectionné(e).
...
\begin{itemize}
	...
	\item Pointer ou dépointer une opération: \keys{Ctrl+P} ou \keys{F12}
