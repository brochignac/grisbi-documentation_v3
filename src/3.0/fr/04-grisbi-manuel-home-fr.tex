...
\begin{itemize}
	\item dans le menu \menus{Éditer - Préférences}:
		\begin{itemize}
...
\item \menus{Rechercher} (raccourci-clavier \keys{Ctrl+F}) (voir le chapitre \vref{search}, \menus{Recherches}):
	\begin{itemize}
...
\begin{itemize}
	...
	\item Sur un compte ou sur l'onglet Échéancier:
		...
		\end{itemize}
	\item Sur un compte sélectionné:
		\begin{itemize}
			\item Affiche la fenêtre \menus{Rechercher}: \keys{Ctrl+F}
		\end{itemize}
	\item Sur l'onglet États:
		\begin{itemize}
