...
\item \menus{Rechercher} (raccourci-clavier \keys{Ctrl+F}):
	\begin{itemize}
		\item affiche la fenêtre de recherche quand vous sélectionnez:
			\begin{itemize}
				...
				(voir le chapitre \vref{accounts-search}, \menus{Recherche alphanumérique}) \textcolor{red}{-> A CRÉER} %TODO to create
 			\end{itemize}
 		\item ouvre la fenêtre de propriétés de l'état quand l'onglet \frquote{États} du panneau de navigation ou un état est sélectionné, voir le chapitre \vref{reports-creation}, \menus{Création d'un état};
	\end{itemize}
