...
\item \menus{Rechercher}: affiche la fenêtre de	recherche d'une chaîne de caractères ou d'un montant, """voir le chapitre \vref{reportscreation}, \menus{Création d'un état}"""; %TODO to modify
