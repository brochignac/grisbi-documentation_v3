...
\begin{minipage}{.7\linewidth}
	\begin{itemize}[rightmargin=.6cm]
		...
		dans votre navigateur ou dans votre lecteur \gls{PDF} selon votre paramétrage (voir \vref{setup-general-various-general-display}, \menus{Affichage de l'aide}) (raccourci-clavier \keys{F1});
