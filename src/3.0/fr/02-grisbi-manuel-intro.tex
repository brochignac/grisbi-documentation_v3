...
Ce manuel a été écrit avec le \gls{formateur de texte} \gls{LaTeX}\index{latex@\LaTeX}, et il est disponible sous le \gls{format de fichier} \gls{PDF}\index{PDF} ou \gls{HTML}\index{HTML}, avec illustrations (copies d'écran) dans ces deux formats. 
...
\begin{itemize}
	\item pour le format \gls{PDF}\index{PDF}: 
		\begin{itemize}
	...
	\item pour le format \gls{HTML}\index{HTML}:
		\begin{itemize}
