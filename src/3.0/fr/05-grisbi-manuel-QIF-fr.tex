...
\vspacepdf{5mm}
Dans le menu \menus{Fichier} de Grisbi, choisissez l'option \menus{Importer un fichier} ou le raccourci-clavier \keys{Ctrl+I}, ce qui ouvre la fenêtre de l'assistant d'importation. L'importation d'un seul fichier de compte se déroule en cinq étapes, auxquelles il faudra rajouter une étape par compte supplémentaire:
%TODO: FOLLOWING
\begin{enumerate}
	...
	\end{figure}
		\begin{itemize}
			...
			\item créer une règle d'importation rapide si le fichier est au format \gls{QIF} ou \gls{OFX},%TODO A VERIFIER
