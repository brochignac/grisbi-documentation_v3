...
\vspacepdf{5mm}
Dans le menu \menus{Fichier} de Grisbi, choisissez l'option \menus{Importer un fichier}, ce qui ouvre la fenêtre de l'assistant d'importation. L'importation d'un fichier de compte se déroule en cinq étapes, auquelles il faudra rajouter une étape de plus par compte supplémentaire:
%TODO: FOLLOWING
\begin{enumerate}
