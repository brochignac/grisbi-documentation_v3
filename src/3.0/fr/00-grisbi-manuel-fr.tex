...
% 2024/12
% - add "french" in scrbook \documentclass
% - include macro-3.0.tex packages
% - modify depth of toc
% - add/cleaning comments
% 2025/09
% - change "color" to "xcolor" package
% 2025/12
% - add package "tabularray" in place of packages "tabularx" & "array"
% 2026/01
% - update this history
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
...
\usepackage{fdsymbol}				% provide various symbols (\triangledown)
%\usepackage{txfonts}
%\usepackage{ae}
%\usepackage{cmbright}
...
\usepackage{wrapfig2}				% for text around image (replace picins)
...
%\usepackage{siunitx}				% to typeset numbers and units correctly, called by "tabularray" package option
\usepackage{tabularray}				% replace \tabularx and \array
\UseTblrLibrary{siunitx}			% to align decimal separator of number in table, using "siunitx" package
\sisetup{%							% "siunitx" control options
		locale=FR,					% define locate to obtain comma as decimal separator
		mode=match					% to keep manual default font for number (instead of default=math)
}					
%\usepackage{array}					% improve \tabular
...
\setcounter{secnumdepth}{3}				% add section number for \subsubsection (i.e. 2.3.1.5)
...
\newcommand{\Attention}{\textcolor{red}{\strong{\textsf{Attention}}}}	% add \Attention{} cmd
...
\author{%
	...
	Copyright © 2024-202x Dominique \familyname{Brochard}\\	
...
\date{%
	Version 3.0 de 2026 (provisoire)
}
%\else
...
\setlength{\fboxsep}{2pt}				% define \fboxsep (default=3pt) for \colorbox for the whole handbook
										% use {\setlength{\fboxsep}{new-value}\colorbox[RGB]{x,y,z}{text}} for other new-value
...
\include{03-grisbi-manuel-start-fr}				% renamed from grisbi-manuel-start
%\cleardoubleemptypage

\include{04-grisbi-manuel-home-fr}				% renamed from grisbi-manuel-home
%\cleardoubleemptypage		

\include{05-grisbi-manuel-importexport-fr}		% renamed from grisbi-manuel-QIF
%\cleardoubleemptypage

\include{06-grisbi-manuel-datamanagement-fr}	% renamed from grisbi-manuel-datamanagement-2.0
%\cleardoubleemptypage

\include{07-grisbi-manuel-accounts-fr}			% renamed from grisbi-manuel-datamanagement-2.0
%\cleardoubleemptypage

\include{08-grisbi-manuel-transactions-fr}		% renamed from grisbi-manuel-transactions-2.0
%\cleardoubleemptypage

\include{09-grisbi-manuel-reconciliation-fr}	% renamed from grisbi-manuel-reconciliation-2.0 
%\cleardoubleemptypage

\include{10-grisbi-manuel-planned-fr}			% renamed from grisbi-manuel-planned-2.0
%\cleardoubleemptypage

\include{11-grisbi-manuel-search-fr}			% TODO: update screenshots and text "search", remove % when finished
%\cleardoubleemptypage
