...
\include{07-grisbi-manuel-accounts-fr}			% renamed from 08-grisbi-manuel-datamanagement-2.0 TODO: update screenshots and text "accounts", remove % when finished
%\cleardoubleemptypage

\include{08-grisbi-manuel-transactions-fr}		% renamed from 09-grisbi-manuel-transactions-2.0 TODO: update screenshots and text "transactions", remove % when finished
%\cleardoubleemptypage
