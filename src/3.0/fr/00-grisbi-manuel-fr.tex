...
%\usepackage{siunitx}				% to typeset numbers and units correctly and easily
\usepackage{tabularray}				% replace \tabularx and \array
\UseTblrLibrary{siunitx}			% use to align decimal point of number in table
\sisetup{locale=FR,					% define locate to obtain comma as decimal separator, use by "siunitx"
		mode=match					% keeping default font of manuel (default=math)
		}					
