...
% espace pour changement de thème
\vspacepdf{5mm}
Das Navigationsbereich zeigt den Namen des ausgewählten Kontos auf einem {\setlength{\fboxsep}{2pt}\colorbox[RGB]{235,149,149}{dunkelrosa}} {\setlength{\fboxsep}{2pt}\colorbox[RGB]{235,149,149}{Hintergrund}} an; die Informationsleiste zeigt links den Kontonamen und ganz rechts den Kontostand an; das Bereich details zeigt standardmäßig zwei Registerkarten an:
