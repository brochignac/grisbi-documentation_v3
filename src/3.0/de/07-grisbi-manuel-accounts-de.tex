...
\noindent
\underline{\textbf{Übersetzungshinweis}}: \textbf{der Verfasser der folgenden Abschnitte verfügt nicht über die erforderlichen Sprach- und Buchhaltungskenntnisse und kann daher keine Gewähr für die Richtigkeit der verwendeten Begriffe übernehmen. Korrekturen sind willkommen}.
%Note de traduction: l'auteur des sections suivantes, n'ayant pas les compétences linguistiques et comptables allemandes, ne garantit pas l'exactitude des termes employés. Un correcteur sera le bienvenu.
...
\begin{tblr}{
	...
	07/01/2025   											& Ameri Credit & 350.00			   & \menus{Splittbuchungen}	  \\
	&				 &					   &							  \\
	\hspace{3mm}\textopenbullet{} erste untergeordnete Buchung: &				 & 300.00			   & \menus{Transfer: Bank Ruptcy} \\
	\hspace{3mm}\textopenbullet{} zweite untergeordnete Buchung:  &				 & 48.80			   & \menus{Financial expenses: Borrowing costs} \\
	\hspace{3mm}\textopenbullet{} dritte untergeordnete Buchung:	&			 & 1.20				   & \menus{Insurances}			  \\
\end{tblr}
...
\begin{tblr}{
	...
	06/01/2024 	 & Auto Matisch	 & 25000.00	 & \menus{Transfer:\\} Fixed Assets & Car purchase asset \\
\end{tblr}
...
\begin{tblr}{
	...
	\menus{Datum} & \menus{Empfänger}		& \menus{Ausgaben} & \menus{Kategorien}			   & \menus{Notizen} \\
	06/01/2025 	 & Car depreciation		& 5000.00	    & \menus{Transfer:\\} Fixed Assets & Depreciation: Devaluation \\
\end{tblr}
