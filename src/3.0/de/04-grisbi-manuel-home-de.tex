...
\begin{itemize}
	...
	\item Buchung als verrechnet kennzeichnen: \keys{Ctrl+P} oder \keys{F12}
	%Select or deselect a transaction for a reconciliation: \keys{Ctrl+P}
...
\begin{itemize}
	...
	\begin{itemize}
		\item Liste anzeigen: \keys{\Space{Leertaste}\Space}
		...
		%Se déplacer dans la liste: \keys{\arrowkeyup} ou \keys{\arrowkeydown}
		\item Validieren Sie das Element in der Liste: \keys{\Space{Leertaste}\Space}
