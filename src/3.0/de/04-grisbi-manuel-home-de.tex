...
\begin{itemize}
	\item Die Taste \key{Eingabe \return} ist konfigurierbar (siehe Einstellungen \vref{setup-form-behaviour-enter}): sie ermöglicht es Ihnen, sich entweder im Buchungsformular zu bewegen oder die Eingabe zu bestätigen;
