...
\begin{itemize}
	...
	\item \menus{Buchungen suchen}: zeigt das Suchfeld für Zeichenfolgen oder Beträge an, <<<siehe Kapitel \vref{reports-creation}, \menus{Création d'un état}>>>;%TODO to modify
	\begin{itemize}
