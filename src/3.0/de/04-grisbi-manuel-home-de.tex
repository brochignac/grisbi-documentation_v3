...
\begin{itemize}
	...
	\item \menus{Buchungen suchen} (Tastenkombination \keys{Strg+F}):
		\begin{itemize}
			\item Zeigt das Suchfeld an, wenn ein Konto oder eine Buchung, die Registerkarte \dequote{Empfänger} oder einen Empfänger, die Registerkarte \dequote{Kategorien} oder eine Kategorie, die Registerkarte \dequote{Gruppen} oder eine Gruppe ausgewählt wird, siehe Abschnitt \vref{accounts-search}, \menus{alphanumerische Suche?} -> TO CREATE; %TODO to create
