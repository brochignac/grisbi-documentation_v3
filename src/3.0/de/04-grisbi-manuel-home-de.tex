...
\subsection{Menü\label{home-menus-edit} \menus{Bearbeiten}}
...
\begin{minipage}{.7\linewidth}
	\begin{itemize}[rightmargin=.6cm]
		...
		\item \menus{Buchung erstellen}: ermöglicht die Erstellung einer neuen Transaktion in einem Konto (Tastaturkürzel {Strg+T}), siehe den Abschnitt \vref{transactions-new}, \menus{Saisie d'une nouvelle opération};%TODO to translate
