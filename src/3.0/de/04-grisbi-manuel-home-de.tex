...
\begin{itemize}
	...
	%TODO following
	\item \menus{Buchungen suchen}: zeigt das Suchfeld für Zeichenfolgen oder Beträge an, <<<siehe Kapitel \vref{reportscreation}, \menus{Création d'un état}>>>;%TODO to modify
	...
	\item \menus{Konto erstellen}: Startet den Assistent Konto erstellen für die Erstellung eines neuen Kontos in Ihrer Grisbi-Datei (Tastaturkürzel \keys{Shift+Ctrl+N}), siehe Abschnitt \vref{accounts-new}, \menus{Creating a new account};
