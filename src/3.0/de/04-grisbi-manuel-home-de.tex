...
\begin{itemize}
	...
	\item \menus{Buchungen suchen} (Tastenkombination \keys{Strg+F}):
		\begin{itemize}
			\item Zeigt das Suchfenster an, wenn Sie Folgendes auswählen:
				\begin{itemize}
			...
			(siehe Abschnitt \vref{accounts-search}, \menus{alphanumerische Suche}) \textcolor{red}{ -> TO CREATE} %TODO to create
			%displays the search box when an account or a transaction, the \enquote{Payees} tab or a payee, the \enquote{Categories} tab or a category, the \enquote{Budgetary lines} tab or a budgetary line is selected see chapter \vref{accounts-search}, \menus{alphanumeric search} -> TO CREATE; %TODO to create, 
			%affiche la fenêtre de recherche quand un compte ou une opération, l'onglet \frquote{Tiers} ou un tiers, l'onglet \frquote{Catégories} ou une catégorie, l'onglet \frquote{Imputations budgétaires} ou une imputation budgétaire est sélectionné, voir le chapitre \vref{accounts-search}, \menus{Recherche alphanumérique} -> A CRÉER; %TODO to create
			\item Öffnet das Fenster Bericht bearbeiten, wenn die Registerkarte \dequote{Berichte} im Navigationsbereich oder ein Bericht ausgewählt ist, siehe Abschnitt \vref{reports-creation}, \menus{Création d'un état}>>>;%TODO to modify
			%opens the properties window for a report when the \enquote{Reports} tab of the navigation panel or a report is selected, see chapter \vref{reports-creation}, \menus{Création d'un état}; %TODO to modify
			%ouvre la fenêtre de propriétés de l'état quand l'onglet \frquote{États} du panneau de navigation ou un état est sélectionné, voir le chapitre \vref{reports-creation}, \menus{Création d'un état};
		\end{itemize}
