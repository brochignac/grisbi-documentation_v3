...
Grisbi verfügt über eine Reihe von Tastenkombinationen, die hier nach verschiedenen Themen geordnet sind.
%Grisbi has a number of keyboard shortcuts, presented here according to different themes (see also  \vref{introduction-manual-conventions}, \menus{Typografische Konventionen in diesem Handbuch}).
%TODO following
