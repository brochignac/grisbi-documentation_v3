...
%\include{103-grisbi-manuel-entrance-de}		% TODO update screenshots and text "entrance", uncomment when finished
%\cleardoubleemptypage

\include{03-grisbi-manuel-start-de}			% TODO update screenshots and text "start", uncomment when finished
%\cleardoubleemptypage
