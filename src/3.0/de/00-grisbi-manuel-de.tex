...
\sisetup{%							% "siunitx" control options
	locale=DE,					% define locate to obtain comma as decimal separator
...
\newcommand{\Note}{\textbf{Notiz}}				% add \Note{} cmd - or "Anmerkung"
...
\date{%
	Version 3.0 vom 2026 (vorläufig)
}
%\else
...
\include{04-grisbi-manuel-home-de}
%\cleardoubleemptypage

\include{05-grisbi-manuel-importexport-de}
%\cleardoubleemptypage

\include{06-grisbi-manuel-datamanagement-de}
%\cleardoubleemptypage

\include{07-grisbi-manuel-accounts-de}
%\cleardoubleemptypage

\include{08-grisbi-manuel-transactions-de}
%\cleardoubleemptypage

\include{09-grisbi-manuel-reconciliation-de}
%\cleardoubleemptypage

\include{10-grisbi-manuel-planned-de}
%\cleardoubleemptypage

\include{11-grisbi-manuel-search-de}			% TODO update screenshots and text "search", uncomment when finished
%\cleardoubleemptypage
...
\renewcommand{\glossarypreamble}{\Note{}: die meisten Definitionen der Einträge in diesem Glossar stammen aus den gleichnamigen Artikeln der freien und kollaborativen Enzyklopädie \lang{Wikipédia}\footnote{\urlWikipedia{}}. Obwohl diese Texte verändert und an den besonderen Kontext dieses Glossars angepasst wurden, dankt der Autor Wikipedia für die Bereitstellung dieser Referenzen.\newline}
