...
\include{31-grisbi-manuel-urldef-de}		% include the "grisbi-manuel-urldef" file during the compilation
...
\newcommand{\gequote}[1]{\glqq{}#1\grqq{}}		% add german quotes marks new command -> \gequote{text}=,,text''
...
\include{01-grisbi-manuel-preamble-de} 	 % TODO update screenshots and text "preamble", uncomment when finished
%\cleardoubleemptypage

\include{02-grisbi-manuel-intro-de}			% TODO update screenshots and text "intro", uncomment when finished
%\cleardoubleemptypage
