...
\subsection{Von Version 0.3.0 bis Version 0.3.3}%De la version 0.3.0 à la version 0.3.3}
...
\subsection{Von Version 0.4.0 bis Version 0.4.4}%De la version 0.4.0 à la version 0.4.4}
...
\subsection{Von Version 0.4.5 bis Version 0.6}%De la version 0.4.5 à la version 0.6}
...
\subsection{Neuerungen in Version 0.8}%Nouveautés de la version 0.8}
...
\subsection{Neuerungen in Version 1.0}%Nouveautés de la version 1.0}
...
\subsection{Neuerungen in Version 2.0}%Nouveautés de la version 2.0}
...
\subsection{Neuerungen in Version 3.0}%Nouveautés de la version 3.0}
...
Daniel \familyname{Cartron} a rédigé la documentation jusqu'à la version 0.4.0, fourni des conseils en comptabilité et en ergonomie, et créé le premier site de Grisbi. Sa passion des fichiers de comptes ultra compliqués amène un plus indéniable à la découverte de bogues inédits.
