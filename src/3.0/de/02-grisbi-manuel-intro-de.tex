...
\begin{itemize}
	...
	\item Erstellung Buchung mit Kurzbefehl \keys{Strg+T}%Raccourci-clavier \key{Ctrl}\key{T} pour l'appel d'une nouvelle opération
	\item Aufruf der \menus{Hilfe} mit Kurzbefehl \keys{Strg+H}%Accès direct au manuel de l'utilisateur par le menu \menus{Aide} ou le raccourci-clavier \key{Ctrl}\key{H}
\end{itemize}
