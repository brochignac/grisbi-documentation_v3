...
%Il est accessible directement dans le logiciel Grisbi par le menu \menus{Aide - Manuel} de la barre de menus, sous le format \gls{HTML} avec illustrations.
Es ist direkt in der Grisbi-Software über das Menü \menus{Hilfe - Handbuch} in der Menüleiste im Format \gls{HTML} mit Illustrationen zugänglich.
