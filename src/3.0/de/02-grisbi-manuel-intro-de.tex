...
% END_TODO
	...
	\item \textcolor{red}{\strong{\textsf{Achtung}}}: entweder auf einen Punkt hinweist, der für das Verständnis sehr wichtig ist, oder auf einen Fehler, der nicht gemacht werden darf, da sonst Ihre Daten großen Schaden nehmen können;\newline
	\textcolor{red}{\strong{\textsf{Achtung}}} bezeichnet einen Punkt, der \emph{beachtet werden muss}.
\end{itemize}
