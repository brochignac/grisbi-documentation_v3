...
\begin{itemize}
	...
	\begin{itemize}
		...
		%TODO following
		\item Move in the list: \keys{\arrowkeyup} ou \keys{\arrowkeydown}%Se déplacer dans la liste: \keys{\arrowkeyup} ou \keys{\arrowkeydown}
...
\begin{itemize}
	\item Show the Grisbi preferences window: \keys{Ctrl+Shift \shift+P}%Afficher la fenêtre des préférences de Grisbi: \keys{Ctrl+Maj \shift+P}
\end{itemize}
...
\begin{itemize}
\item Open the Grisbi Manual: \key{Ctrl}\key{H}%Ouvrir le Manuel de Grisbi: \keys{F1}
\end{itemize}