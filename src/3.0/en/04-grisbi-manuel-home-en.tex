...
\begin{itemize}
	...
	\item Select or deselect a transaction for a reconciliation: \keys{Ctrl+P} or \keys{F12}%Pointer ou dépointer une opération: \keys{Ctrl+P}
