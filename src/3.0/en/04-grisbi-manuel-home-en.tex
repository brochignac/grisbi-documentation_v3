...
\begin{itemize}
	...
	\item \menus{Search} (shortcut \keys{Ctrl+F}):
		\begin{itemize}
			\item displays the search box when you select:
				\begin{itemize}
			 	...
			 	(see chapter \vref{accounts-search}, \menus{alphanumeric search})\textcolor{red}{-> TO CREATE} %TODO to create, 
			...
			\item opens the properties window for a report when the \enquote{Reports} tab of the navigation panel or a report is selected, see chapter \vref{reports-creation}, \menus{Création d'un état}; %TODO to modify
...
\begin{itemize}
	...
	\end{itemize}
	\item On a selected account:%TODO to update
	%Sur un compte sélectionné:%TODO to update
	\begin{itemize}
		\item Displays the character search window: \keys{Ctrl+F}%Affiche la fenêtre de recherche de caractères: \keys{Ctrl+F}
	\end{itemize}
	\item On the Reports tab:%TODO to update
	%Sur l'onglet États
	\begin{itemize}
		\item Opens the search report properties window: \keys{Ctrl+F}%Ouvre la fenêtre des propriétés d'un état de recherche: \keys{Ctrl+F}
	\end{itemize}	
