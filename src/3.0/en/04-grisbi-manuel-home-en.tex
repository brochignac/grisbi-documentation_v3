...
\begin{itemize}
	...
	\item \menus{Search} (shortcut \keys{Ctrl+F}):
		\begin{itemize}
			\item displays the search box when an account or a transaction, the \enquote{Payees} tab or a payee, the \enquote{Categories} tab or a category, the \enquote{Budgetary lines} tab or a budgetary line is selected see chapter \vref{accounts-search}, \menus{alphanumeric search} -> TO CREATE; %TODO to create, 
