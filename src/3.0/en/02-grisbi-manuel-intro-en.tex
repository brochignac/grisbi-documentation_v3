...
% END_TODO
	...
	\item \textcolor{red}{\strong{\textsf{Warning}}}: indicates either a point that is very important for understanding, or an error that must not be made on pain of serious damage to your data;\newline
	\textcolor{red}{\strong{Warning}} indicates a point that \emph{must be respected}.
