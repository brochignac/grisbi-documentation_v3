...
In the \menu{File} menu select the \menu{Export accounts as QIF/CSV file} that opens the Export Accounts Wizard. There are four steps to exporting accounts:
