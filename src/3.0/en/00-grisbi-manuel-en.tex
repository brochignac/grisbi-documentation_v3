...
\include{01-grisbi-manuel-preamble-en}		% TODO update screenshots and text "preamble", uncomment when finished
%\cleardoubleemptypage

\include{02-grisbi-manuel-intro-en}			% TODO update screenshots and text "intro", uncomment when finished
%\cleardoubleemptypage

%\include{103-grisbi-manuel-entrance-en}		% TODO update screenshots and text "entrance", uncomment when finished
%\cleardoubleemptypage

\include{03-grisbi-manuel-start-en}			% TODO update screenshots and text "start", uncomment when finished
%\cleardoubleemptypage
