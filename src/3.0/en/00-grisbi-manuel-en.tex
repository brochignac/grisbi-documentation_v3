...
\renewcommand{\labelitemiii}{-}	% change 2nd level list marker: "-" to \textopenbullet
\renewcommand{\labelitemiv}{*}	% change 2nd level list marker: "-" to \textopenbullet
...
\include{04-grisbi-manuel-home-en}			% TODO update screenshots and text "home", uncomment when finished
%\cleardoubleemptypage
