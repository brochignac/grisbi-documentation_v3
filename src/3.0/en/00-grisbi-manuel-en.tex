...
\input{31-grisbi-manuel-urldef-en}		% include the "grisbi-manuel-urldef" file during the compilation
...
\date{%
	Version 3.0 of 2026 (provisional)
}
%\else
...
\include{01-grisbi-manuel-preamble-en}
%\cleardoubleemptypage

\include{02-grisbi-manuel-intro-en}
%\cleardoubleemptypage

%\include{103-grisbi-manuel-entrance-en}	% moved to the begining of 04-grisbi-manuel-home-en
%\cleardoubleemptypage

\include{03-grisbi-manuel-start-en}
%\cleardoubleemptypage

\include{04-grisbi-manuel-home-en}
%\cleardoubleemptypage

\include{05-grisbi-manuel-importexport-en}
%\cleardoubleemptypage

\include{06-grisbi-manuel-datamanagement-en}
%\cleardoubleemptypage

\include{07-grisbi-manuel-accounts-en}
%\cleardoubleemptypage

\include{08-grisbi-manuel-transactions-en}
%\cleardoubleemptypage

\include{09-grisbi-manuel-reconciliation-en}
%\cleardoubleemptypage

\include{10-grisbi-manuel-planned-en}			% renamed from grisbi-manuel-planned-en
%\cleardoubleemptypage

\include{11-grisbi-manuel-search-en}			% TODO update screenshots and text "search", uncomment when finished
%\cleardoubleemptypage
...
\renewcommand{\glossarypreamble}{\Note{}: most of the definitions in this glossary are taken from articles of the same name in the free, collaborative encyclopaedia \lang{Wikipédia}\footnote{\urlWikipedia{}}. Although these texts have been modified and adapted to the specific context of this glossary, the author would like to thank Wikipedia for providing these references.\newline}
