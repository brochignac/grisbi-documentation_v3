...
% espace pour changement de thème
\vspacepdf{2mm}
Pour des raisons de lisibilité de l'affichage, Grisbi présente une alternance de couleurs de {\setlength{\fboxsep}{2pt}\colorbox[RGB]{215,215,255}{fond violet}} et blanc à chaque ligne.
...
Un calendrier\refimage{planned-transactions-calendar-img} s'affiche en bas du panneau de navigation\refimage{planned-transactions-display-img}. Le jour en cours est {\setlength{\fboxsep}{2pt}\colorbox[RGB]{198,200,201}{surligné}}, et les dates \textbf{en gras} correspondent aux dates des opérations planifiées de tous les comptes arrivant à échéance.
	...
	\begin{enumerate}
		...
		\begin{itemize}
			\item par sélection dans la liste des opérations où elle s'affichera sur {\setlength{\fboxsep}{2pt}\colorbox[RGB]{245,155,155}{fond rose foncé}},
	...
	% espace pour changement de thème
	\vspacepdf{2mm}
	L'opération sélectionnée précédemment apparaît toujours sur {\setlength{\fboxsep}{2pt}\colorbox[RGB]{245,155,155}{fond rose foncé}}, et l'opération clonée s'affiche dans une nouvelle ligne en-dessous.
