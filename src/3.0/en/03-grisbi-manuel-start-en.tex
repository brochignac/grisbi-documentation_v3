...
\vspacepdf{5mm}
\textcolor{red}{\strong{Warning}}: if you check the option \menu{Encrypt Grisbi file}, the loss of the password will render your file unusable.%si vous cochez l'option \menu{Chiffrer le fichier Grisbi}, la perte du mot de passe rendra votre fichier inutilisable.
\vspacepdf{5mm}
