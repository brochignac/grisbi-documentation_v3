...
The navigation panel can also display, if the budget module has been activated for the selected account, other tabs that are not described in this chapter (see the chapter \vref{budget}, \menus{Provisional Budgets}):
%Le panneau de navigation peut aussi afficher, si le module budgétaire a été activé pour le compte sélectionné, d'autres onglets qui ne sont pas décrits dans ce chapitre (voir le chapitre \vref{budget}, \menus{Budgets Prévisionnels}):
\begin{itemize}
