...
% espace pour changement de thème
\vspacepdf{5mm}
The navigation panel displays the name of the selected account on a \fboxsep=3pt{\colorbox[RGB]{235,149,149}{dark pink background}}; the information bar displays the account name on the left and the account balance on the far right; the details panel displays two tabs by default:
